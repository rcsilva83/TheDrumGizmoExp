...
TEST_CASE("PixelBufferAlphaTest")
{
	...
	SUBCASE("clear_zeros_buffer")
	{
		...
		pba.setPixel(0, 0,
		    dggui::Colour(std::uint8_t(255), std::uint8_t(255),
		        std::uint8_t(255), std::uint8_t(255)));
		pba.setPixel(5, 5,
		    dggui::Colour(std::uint8_t(128), std::uint8_t(128),
	...
	SUBCASE("getLine_returns_correct_pointer")
	{
		dggui::PixelBufferAlpha pba(10, 10);
		pba.setPixel(5, 5,
		    dggui::Colour(std::uint8_t(100), std::uint8_t(150),
		        std::uint8_t(200), std::uint8_t(250)));
	...
	SUBCASE("addPixel_with_partial_alpha_blends")
	{
		...
		// Set initial pixel
		pba.addPixel(5, 5,
		    dggui::Colour(std::uint8_t(100), std::uint8_t(100),
		        std::uint8_t(100), std::uint8_t(255)));

		// Blend with partial alpha
		pba.addPixel(5, 5,
		    dggui::Colour(std::uint8_t(200), std::uint8_t(200),
		        std::uint8_t(200), std::uint8_t(128)));
	...
	SUBCASE("writeLine_out_of_bounds_returns_early")
	{
		...
		pba.setPixel(5, 5,
		    dggui::Colour(std::uint8_t(100), std::uint8_t(100),
		        std::uint8_t(100), std::uint8_t(100)));
	...
	SUBCASE("blendLine_with_zero_alpha_skips")
	{
		...
		{
			pba.setPixel(i, 5,
			    dggui::Colour(std::uint8_t(50), std::uint8_t(50),
			        std::uint8_t(50), std::uint8_t(255)));
		}
...
TEST_CASE("PixelBufferUpdateBufferTest")
{
	...
	{
		// Note: Dirty rect is computed and then clamped to PixelBuffer
		// dimensions
		dggui::PixelBuffer pb(100, 100);
		dggui::PixelBufferAlpha pba(50, 50);
		pba.dirty = true;
