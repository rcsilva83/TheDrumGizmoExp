...
std::string someText = "Hello World - \xd0\xbb\xc3\xa6 \xd0\x91\xd0\xb8\xd0\xb1\xd0\xbb\xd0\xb8\xd0\xbe\xd1\x82\xd0\xb5\xd0\xba\xd0\xb0";
...
CHECK_EQ(TestColour(10, 10, 0, 255),
...
CHECK_EQ(TestColour(10, 10, 0, 128),
         TestColour(pixbuf.pixel(0, 0)));
}
}
}
